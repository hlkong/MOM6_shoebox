...
! the target density profile is based on sb2GnMap12tp2, which uses sb2
! topography (Scotia Arc + continental slopes on all 4 walls)
...
subroutine channel4_initialize_sponges(G, GV, use_temperature, tv, param_file, CSp, h)
  ...
  eta0 = (/0.0, 0.0, 0.0, -3.48, -46.89, -92.27, -143.38, -215.38, -310.32, &
        -440.99, -572.23, -686.10, -795.46, -911.56, -1050.29, -1242.28, -1519.66, &
        -1836.00, -2118.36, -2386.76, -2631.59, -2865.13, -3095.72, -3346.58, -3677.40, &
        -3884.00, -3950.13, -3971.40, -3981.79, -3998.78, -4000.00/)
