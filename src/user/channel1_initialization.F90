module channel1_initialization
...
public channel1_initialize_topography
...
! -----------------------------------------------------------------------------
!> This subroutine sets up the channel1 test case topography.
!> channel1 is similar to channel6 but: the slope along Patagonia is extended to
!the norther boundary, because no sponge is used in this configuration

subroutine channel1_initialize_topography(D, G, param_file, max_depth)
  ...
  real :: sdp = 6.0, ll=6.0   ! the width of the slope in Drake Passage, the half width of continental slope

  character(len=40)  :: mod = "channel1_initialize_topography" ! This subroutine's name.
  ...
  call MOM_mesg("channel1_initialization.F90, channel1_initialize_topography: setting topography", 5)
...
end subroutine channel1_initialize_topography
...
end module channel1_initialization
