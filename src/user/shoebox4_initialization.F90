module shoebox4_initialization
...
public shoebox4_initialize_topography

contains

! -----------------------------------------------------------------------------
!> This subroutine sets up the shoebox4 test case topography.
!> Difference from shoebox2: 
!> no continental slope along the northern wall

subroutine shoebox4_initialize_topography(D, G, param_file, max_depth)
...
#include "version_variable.h"
  character(len=40)  :: mod = "shoebox4_initialize_topography" ! This subroutine's name.
  ...
  call MOM_mesg("  shoebox4_initialization.F90, shoebox4_initialize_topography: setting topography", 5)
...
end subroutine shoebox4_initialize_topography
...
end module shoebox4_initialization
