module channel8_initialization
...
public channel8_initialize_sponges
...
! the target density profile is based on sb2GnMap12tp2KHTH50, which uses sb2
...
!
! difference from channel4's sponge: 
!   based on sb2GnMap12tp2KHTH100, i.e. added a background diffusivity
!
! Notice that the last value of eta0 has been changed to -4000, i.e. ocean floor
! depth, instead of directly using the zonal mean value from computation

subroutine channel8_initialize_sponges(G, GV, use_temperature, tv, param_file, CSp, h)
  ...
  character(len=40)  :: mdl = "channel8_initialize_sponges" ! This subroutine's name
  ...
  eta0 = (/0.0, 0.0, 0.0, -1.49, -48.21, -91.58, -140.71, -208.52, -299.07, &
        -432.51, -568.73, -678.59, -780.93, -889.05, -1018.09, -1192.56, & 
        -1441.64, -1725.71, -1991.43, -2233.96, -2460.23, -2673.44, &
        -2875.55, -3076.06, -3294.92, -3547.44, -3795.60, -3868.18, &
        -3892.68, -3910.09, -4000.0/);
...
end subroutine channel8_initialize_sponges


end module channel8_initialization
