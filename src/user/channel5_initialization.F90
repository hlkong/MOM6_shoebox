module channel5_initialization
...
public channel5_initialize_sponges
...
!   based on sb2GnMap12tp2KHTH50, i.e. added a background diffusivity

subroutine channel5_initialize_sponges(G, GV, use_temperature, tv, param_file, CSp, h)
  ...
  character(len=40)  :: mdl = "channel5_initialize_sponges" ! This subroutine's name
  ...
  eta0 = (/0.0, 0.0, 0.0, -2.387, -46.566, -95.483, -146.337, -214.464, -303.660, &
        -431.954, -566.610, -677.609, -782.564, -894.180, -1027.944, -1211.115, &
        -1476.903, -1779.082, -2050.868, -2296.677, -2524.968, -2741.088, &
        -2948.930, -3161.720, -3409.788, -3723.765, -3849.443, -3880.641, &
        -3896.270, -3909.249, -4000.0/)
...
end subroutine channel5_initialize_sponges


end module channel5_initialization
